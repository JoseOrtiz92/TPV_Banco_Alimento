...
Public Class CRGraficoSalida
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TPV.CRGraficoSalida.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRGraficoSalida
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRGraficoSalida = New CRGraficoSalida()
        rpt.Site = Me.Site
        Return rpt
    End Function
