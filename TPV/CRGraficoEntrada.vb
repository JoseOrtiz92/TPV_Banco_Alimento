...
Public Class CRGraficoEntrada
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TPV.CRGraficoEntrada.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRGraficoEntrada
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRGraficoEntrada = New CRGraficoEntrada()
        rpt.Site = Me.Site
        Return rpt
    End Function
